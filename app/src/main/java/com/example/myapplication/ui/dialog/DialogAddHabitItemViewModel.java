...
public class DialogAddHabitItemViewModel extends AndroidViewModel {
    ...
    public DialogAddHabitItemViewModel(
    ...
    public static class Factory implements ViewModelProvider.Factory {
        ...
        public <T extends ViewModel> T create(@NonNull Class<T> modelClass) {
            return (T) new DialogAddHabitItemViewModel(mApplication);
        }
    }
}
